...
return{SCHEMA_VERSION,TRACE_VERSION,FEATURE_FLAG,COARSE_FEATURE_FLAG,COARSE_SCHEMA_VERSION,LEASE_SCHEMA_VERSION,ACTUAL_HISTORY_SCHEMA_VERSION,enabled,coarseEnabled,createObserver,getObserver,observerForBoundary,attachBoundary,createCanonicalObservation,createCoarseSpatial,activateCoarseState,syncBallDerived,advanceCoarseTo,refreshIntents,beginPass,tryCausalTurnover,physicalOwner,adoptHandback,resolutionSnapshot,resolutionContext,coarseDiagnostics,roundTrip,schemaRoundTripEqual,createResolutionRandom,appendActualHistory,createResolutionLease,resolutionLeaseForContext,prepareResolutionLease,acquireResolutionLease,bindResolutionAdapter,releaseResolutionLease,leaseAudit};
});
