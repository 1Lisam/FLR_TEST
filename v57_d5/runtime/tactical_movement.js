...
function roleEligibleForThreat(m,d,threat){
  if(offBallPolicy(m)==='CURRENT')return true;
  ...
  if(d.role==='WF'){
    ...
    const side=Math.sign((threat.localY??34)-34),ownSide=sideSign(d.slot);
    return threat.localX>34&&(!side||!ownSide||side===ownSide);
  }
