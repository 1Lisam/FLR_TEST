...
os.chdir(work)
for name in ['v054_defense_normalization.py','v054_defense_normalization_cm_guard.py','v054_offside_law11_fix.py','v054_backline_drop_together_fix.py','v054_second_ball_layer_fix.py']:
