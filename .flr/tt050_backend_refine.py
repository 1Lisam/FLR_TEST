...
# Worker stores the exact integrated debug object only. No GitHub token is stored in Cloudflare.
...
# Browser uploads the full makeIntegratedDebug object, then opens the normal GitHub issue page itself.
...
t2,n=re.subn(old,lambda _m:new,t,count=1,flags=re.S)
